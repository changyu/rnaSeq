...
<form id='sqfile' action="chip_seq.php" method="post" enctype="multipart/form-data" autocomplete="off">
<b>Project name:</b> <input type="text" name="proj" id="proj"  style="width:40%" value="ChIP.<?php echo date("Y-m-d");?>"><label><b>Type:</b></label> <select name="ptype">
